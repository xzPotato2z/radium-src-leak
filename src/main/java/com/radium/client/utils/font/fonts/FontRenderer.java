...
import com.radium.client.utils.font.util.BufferUtils;
import com.radium.client.utils.font.util.Colors;
import com.radium.client.utils.font.util.RendererUtils;
...
public class FontRenderer implements Closeable {
     ...
     * Compatible with GlyphPageFontRenderer signature.
     *
     ...
     * @return The X coordinate after drawing
     */
    ...
    public int getFontHeight() {
        return (int) (getStringHeight("A") / 2f); // Approximate height logic, adjust if needed
    }
